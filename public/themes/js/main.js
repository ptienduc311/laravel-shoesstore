$(document).ready(function () {
    ...
    function updateQuantity(delta) {
        var numInput = document.getElementById("num-order");
        var currentQuantity = parseInt(numInput.value, 10) || 0;
        var newQuantity = currentQuantity + delta;

        if (
            newQuantity >= parseInt(numInput.min) &&
            newQuantity <= parseInt(numInput.max)
        ) {
            numInput.value = newQuantity;
        }
    }
