        ...
        <div id="card" class="mb-5">
            <div class="card-header">
                <div class="d-flex justify-content-between w-40">
                    <h3 id="index">Danh sách bài viết</h3>
                    <a href="{{ route('post.add') }}" title="" id="add-new">Thêm mới</a>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="{{ route('post.edit', $post['id']) }}" title="Sửa"
                                                    class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                            </li>
                                            <li><a href="{{ route('post.delete', $post['id']) }}" title="Xóa"
                                                    class="delete"
                                    ...
                                    <td><span
                                            class="tbody-text">{{ $post::find($post['id'])->category['category_name'] }}</span>
                                    </td>
                                    <td><span class="tbody-text">{{ $post['status'] }}</span></td>
                                    <td><span class="tbody-text">{{ $post['created_by'] }}</span></td>
