    ...
    <div id="content" class="fl-right">
        ...
        <div class="section" id="detail-page">
            <div class="section-detail">
                {!! Form::open(['route' => 'slider.store', 'method' => 'POST', 'files' => true, 'id' => 'form-upload-single']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('display_order', old('display_order'), ['id' => 'display_order', 'class' => 'form-control']) !!}
                </div>
                @error('display_order')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('status', $options, '', ['id' => 'status','style' => 'width: 15% !important;']) !!}
                </div>
                @error('status')
                    <small class="text-danger">{{ $message }}</small>
                @enderror
